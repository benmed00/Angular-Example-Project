...
export class ShopCardComponent {
  ...
  constructor(
    ...
    iconRegistry.addSvgIcon(
      'like',
      sanitizer.bypassSecurityTrustResourceUrl('assets/imgs/icons/like.svg')
    );
    iconRegistry.addSvgIcon(
      'dislike',
      sanitizer.bypassSecurityTrustResourceUrl('assets/imgs/icons/dislike.svg')
    );
  }
  ...
  toggleLike(id: string) {
    ...
    if (this.isLiked(id)) {
      ...
      this.dataService
        .unLikeShop(id)
        .subscribe(
          this.toggleLikeSuccess.bind(this),
  ...
  isLiked(id: string): boolean {
    ...
    const res = user.likedShops.find(e => e === id);
    return res != null;
  }

  updateStorage(likedItems) {
    const currentUser: Account = this.storage.getUser();
